In this project, i am  going to create an age calculator. As you can see from the final version of the project, i have a container here with the title age calculator with an input of a date. 
